...
const MAP = {
  // astronomy
  'astro-venus': 'venus planet solar system',
  'astro-neutron': 'nebula deep space',
  'astro-stars-sand': 'milky way night sky',
  'astro-sun-mass': 'solar flare sun',
  'astro-footprints': 'moon surface craters',
  'astro-saturn-float': 'saturn planet rings',
  // physics
  'phys-sunlight': 'sun rays sky',
  'phys-photon': 'sun solar corona',
  'phys-timehead': 'clock time',
  'phys-quantum-tunnel': 'abstract light particles',
  'phys-absolute-zero': 'frost ice crystals',
  'phys-superfluid': 'blue liquid drop',
  // biology
  'bio-microbiome': 'bacteria microbiology',
  'bio-octopus': 'octopus underwater ocean',
  'bio-dna-length': 'dna helix',
  'bio-tardigrade': 'tardigrade water bear',
  'bio-trees-network': 'forest fog trees',
  'bio-banana-dna': 'bananas fruit',
  // chemistry
  'chem-glass': 'glass blowing molten',
  'chem-carbon': 'diamond crystal',
  'chem-ice-floats': 'iceberg',
  'chem-gallium': 'liquid metal',
  'chem-mpemba': 'ice cubes water',
  // medicine
  'med-stomach': 'human anatomy organs',
  'med-heartbeats': 'human heart anatomy',
  'med-cornea': 'eye iris macro',
  'med-bone': 'human skeleton',
  'med-fever': 'thermometer fever',
  // neuroscience
  'neuro-energy': 'human brain',
  'neuro-speed': 'neuron nerve cells',
  'neuro-gut': 'intestine digestive anatomy',
  'neuro-memory': 'brain abstract mind',
  'neuro-tickle': 'feather macro',
}
